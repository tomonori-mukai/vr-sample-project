...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_player_operation p_player_operation;
        ...
        public static SteamVR_Input_ActionSet_player_operation player_operation
        {
            get
            {
                return SteamVR_Actions.p_player_operation.GetCopy<SteamVR_Input_ActionSet_player_operation>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_player_operation = ((SteamVR_Input_ActionSet_player_operation)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_player_operation>("/actions/player_operation")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.player_operation};
        }
    }
}
